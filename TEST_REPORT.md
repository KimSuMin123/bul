...
| **10** | 수료증 발급 | 수료증 보기/발급 모달 오픈 | 사단법인 세화불학원 정식 수료증(A4 규격/직인) 렌더링 | 정식 수료증 및 고유 발급번호 출력 | **PASS** |
...
10. `step_10_certificate_modal_issued_20260920044516.png` : 사단법인 세화불학원 정식 수료증(A4 규격/직인) 모달
