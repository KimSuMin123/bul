...
<body>
  ...
  <div class="presentation-container">
    ...
    <section class="slide-page" style="text-align: center; padding: 90px 40px;">
      ...
      <div style="color: var(--color-gold-dark); font-weight: 700; letter-spacing: 2px; font-size: 15px; margin-bottom: 12px;">[사]세화붓다아카데미 공식 발간</div>
    ...
    <section class="slide-page">
      ...
      <div class="slide-body">
        <div class="slide-text">
          <p><strong>[사]세화붓다아카데미</strong>는 시공간의 제약 없이 정통 불교 승가 의례의 법식과 교학을 배우는 전문 온라인 배움터입니다.</p>
      ...
      <div class="slide-body">
        <div class="slide-text">
          ...
          <ul class="spec-list">
            ...
            <li><strong>대기상태 (pending)</strong>: 온라인에서는 대기상태로 우선 접수되며, 교학처(010-4702-0283)에 방문하여 수납을 완료하면 관리자 승인을 통해 즉시 [수강 중]으로 전환됩니다.</li>
          </ul>
        </div>
        <div>
          <div class="image-card" style="margin-bottom: 12px;">
