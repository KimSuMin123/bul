...
const SEO_CONFIG = {
  home: {
    title: '사단법인 세화붓다아카데미 | 정통 불교의례법사 온라인 교육원',
    description: '사단법인 세화불학원 부설 세화붓다아카데미. 불교의례법사 정규 VOD 교육 및 문화체육관광부 소관 공인 수료증 발급 플랫폼.'
  },
  courseDetail: {
  ...
  verify: {
    ...
    description: '사단법인 세화불학원이 발급한 공인 수료증의 진위 여부를 실시간으로 대조 검증합니다.'
  },
  login: {
    title: '로그인 | 세화붓다아카데미',
